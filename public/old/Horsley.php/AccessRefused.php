...
<!-- InstanceBeginEditable name="body" -->
      ...
      <div style="width:550px; height:500px;">
        <br /><br />
        <font size="4">HTTP 401 Error : <b>User Not Authorised</b></font>
        <br /><br />
        Sorry, but we've experienced a problem authorising your request. This may be because you've entered incorrect credentials at
        login, or your current session has expired. 
        <br />
        Please close your web browser and then try again.<br /><br />      
      </div>
