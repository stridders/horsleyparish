...
<html ng-app="horsley">
	...
	<body>
		...
		<script type="text/javascript">
			$(window).on('beforeunload', function()"""),format.raw/*145.43*/("""{"""),format.raw/*145.44*/("""
				"""),format.raw/*146.5*/("""$(window).scrollTop(0);
